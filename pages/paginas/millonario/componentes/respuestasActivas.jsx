        ...
        <>
            < >
                {respuestas.map((key, i) => {
                    return (
                        <div
                            className={gameChoose == i ? 'wdt-50 fnt-larger border-3-green Ia-center Ij-center hgtI-30 flex-row bgcolor-green' : (gameChoose == i || primeraEleccion == i) && primeraEleccion == gameChoose ? 'wdt-50 fnt-larger border-3-green Ia-center Ij-center hgtI-30 flex-row bgcolor-green' : primeraEleccion == i ? primeraEleccion != gameChoose && gameChoose != -1 ? 'wdt-45 fnt-larger border-3-green Ia-center Ij-center hgtI-30 flex-row bgcolor-red' : 'wdt-45 fnt-larger border-3-green Ia-center Ij-center hgtI-30 flex-row bgcolor-blue' : helpRequired ? choosed === i || i === playerChoose ? 'wdt-45 fnt-larger border-3-green Ia-center Ij-center hgtI-30 flex-row' : `wdt-45 fnt-larger ${key !== '' ? 'border-3-white' : ''} Ia-center Ij-center hgtI-30 flex-row` : i === playerChoose || i === choosed ? 'wdt-45 fnt-larger border-3-green Ia-center Ij-center hgtI-30 flex-row' : `wdt-45 fnt-larger ${key !== '' ? 'border-3-white' : ''} Ia-center Ij-center hgtI-30 flex-row`}
