...
const ComponenteJugador = (props) => {
    ...
    const { lastMin = false, lostGame = false, winning = false, eltiempo = -1,   warningPreStreamNeedingHelp=false, setwarningPreStreamNeedingHelp=console.log,sethelpPreStream=console.log, helpRes=false, helpPreStream =false, acceptHelp=false,usersInRegister=[], actualPlayer = {
        name: '',
        ip: ''
                ...
                gameActive ?
                    <>
                        <div className={playerType === 'jugando' ? "fontcolorInedit-white wdt-100 Ia-center Ij-center hgtI-15" : "fontcolorInedit-white wdt-100 Ia-center Ij-center hgtI-15"}>
                            <BarraInfo warningPreStreamNeedingHelp={warningPreStreamNeedingHelp} setwarningPreStreamNeedingHelp={setwarningPreStreamNeedingHelp}      usersInRegister={usersInRegister} nowInlevel={nowInlevel} actualPlayer={actualPlayer} playerData={playerData}
