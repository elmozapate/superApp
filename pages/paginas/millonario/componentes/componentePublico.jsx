...
const ComponentePublico = (props) => {
    ...
    const {helpTime=0, inHelping = false, lastMin = false, lostGame = false, winning = false, eltiempo = -1, sethelpPreStream = console.log, helpRes = false, helpPreStream = false, acceptHelp = false, actualPlayer = {
        name: '',
        ip: ''
