...
const BotonesModo = (props) => {
    const { logOut=console.log, isRegister = false, setmultiPlayerGo = console.log, setRoomName = console.log, setmultiPlayerReady = console.log, setsinglePlayerReady = console.log, cambiarModo = console.log, changeMode = 'sinRegistro', chooseState = false, setChooseState = console.log } = props
    return (
        <>
            {chooseState ?
                <>
                    ...
                    {isRegister ? <button className={'btn-azteca pointer bgInedit-red pointer'} onClick={(e) => {
                        e.preventDefault();
                        logOut()
