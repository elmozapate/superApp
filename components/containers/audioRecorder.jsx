...
const VoiceRecorder = ({ userName = '',setmediaAsk = console.log, urlAudio = '', inMedia = false, setinMedia = console.log, seturlAudio = console.log, setrecordingVoice = console.log, recordingVoice = false, setRecorded = console.log, sendVideo = console.log }) => {
    ...
    const Upload = (action) => {
        ...
        const u = storage.ref(`/chat/Audio/${userName}/${action ? 'test' : `${ip}`}.mp3`).put(myFile)
        u.on(
            'state_changed',
...
cont = 30
    ...
    return (
        <div className={inMedia !== 0 && inMedia !== 2 ? 'hide' : 'flex-row min-width align-center justify-center column'}>
                ...
                <div className="flex-row min-width align-center justify-center">
                    <button
                        ...
                        onClick={(e) => {
                            ...
                            setrecordingVoice(true); setinMedia(2);
                        }}
                    >Nota de voz</button>
                    <button
                        id='btnStart'
 ...
 */                    >Pausa</button>
            ...
            <div className="flex-row min-width align-center justify-center column ">
                ...
                <audio className="hide" id="audioPlay" muted></audio>
                {/* {urlAudio && status === 'idle' && ( */}
                <div className="flex-row I-column min-width align-center mrl-20 justify-center">
                    <audio className={finishRecordingVoice ? '' : "hide"} id="audioSave" controls />
